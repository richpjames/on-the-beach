...
import { artists, musicItems, musicLinks, sources } from "../adapters/db/schema";
...
import { searchSpotify } from "../adapters/spotify/index";
import { searchYouTube } from "../adapters/youtube/index";
