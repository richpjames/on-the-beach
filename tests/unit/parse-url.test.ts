...
describe('parseUrl - apple music', () => {
  test('identifies apple music album link and extracts title', () => {
    const result = parseUrl(
      'https://music.apple.com/es/album/el-poder-verde/1810282984?l=en-GB'
    )
  ...
  test('strips query params from normalized URL', () => {
    ...
    expect(result.normalizedUrl).toBe(
      'https://music.apple.com/es/album/el-poder-verde/1810282984'
    )
  })
  ...
  test('identifies music video link and extracts title', () => {
    const result = parseUrl(
      'https://music.apple.com/us/music-video/bad-guy/1461695557'
    )
  ...
  test('identifies station link', () => {
    const result = parseUrl(
      'https://music.apple.com/us/station/pure-dance/ra.978194965'
    )
