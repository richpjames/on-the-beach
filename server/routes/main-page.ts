...
<html lang="en">
  ...
  <body>
      ...
      <div id="now-playing-panel" class="now-playing-panel" hidden>
        <div id="now-playing-player" class="now-playing-panel__player" aria-hidden="true"></div>
        <div class="now-playing-panel__bar">
          <span class="now-playing-panel__icon" aria-hidden="true">♫</span>
          <button id="now-playing-toggle" class="now-playing-panel__info" title="Toggle player">
            <span id="now-playing-title" class="now-playing-panel__title"></span>
            <span id="now-playing-artist" class="now-playing-panel__artist"></span>
          </button>
          <a id="now-playing-details" href="#" class="now-playing-panel__details btn btn--ghost">Details ↗</a>
          <button id="now-playing-stop" class="now-playing-panel__btn" aria-label="Stop playback" title="Stop">✕</button>
        </div>
      </div>
