...
- `server/release-resolver.ts` (720 lines) deliberately fuses Discogs **and** MusicBrainz to score a match. Organising purely by source has nowhere to put it — it is not Discogs code or MusicBrainz code, it is a use case that consumes both.
